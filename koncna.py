...
def pripravi():
    regex_stanovanja = re.compile(
        r'<a href=".*?" title="(?P<id>\d*)".*?<span class="title">(?P<ime>.*?)</span></a></h2>.*?'
    ...
    for html_datoteka in orodja.datoteke('zajeta-bezigradP/'):
        ...
        orodja.zapisi_tabelo(bezigrad, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
    ...
    for html_datoteka in orodja.datoteke('zajeta-centerP/'):
        ...
        orodja.zapisi_tabelo(center, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
    ...
    for html_datoteka in orodja.datoteke('zajeta-moste-poljeP/'):
        ...
        orodja.zapisi_tabelo(mostePolje, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
    ...
    for html_datoteka in orodja.datoteke('zajeta-siskaP/'):
        ...
        orodja.zapisi_tabelo(siska, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
    ...
    for html_datoteka in orodja.datoteke('zajeta-vic-rudnikP/'):
        ...
        orodja.zapisi_tabelo(vicRudnik, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
                             'csv-datotekeP/vicRudnik.csv')
        for tip in re.finditer(regex_tipa, orodja.vsebina_datoteke(html_datoteka)):
            tipi.append(pocisti_tip(tip))

    orodja.zapisi_tabelo(stanovanja, ['id', 'ime', 'podrocje', 'nadstropje', 'leto', 'velikost', 'cena'],
